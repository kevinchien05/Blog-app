            ...
            <form @submit.prevent="">
                ...
                <div class="flex flex-col mt-6 gap-3">
                    <div class="flex flex-col gap-1">
                        ...
                        <InputText id="email" :invalid="submitted && !user.email && !status.success" v-model="user.email" placeholder="abcde@gmail.com" class="w-full" />
                        <span class="text-xs text-red-600" v-if="submitted && !user.email && !status.success">Email is empty!</span>
                    </div>
                </div>
